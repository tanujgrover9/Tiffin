    ...
    <section className="px-8 md:px-16 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 justify-center w-full max-w-5xl mx-auto">
        {categories.map((cat, i) => {
          ...
          const tagColor = isDiet ? "text-lime-600 bg-lime-100" : "text-orange-600 bg-orange-100";
          const btnColor = isDiet ? "bg-lime-500 hover:bg-lime-600" : "bg-orange-500 hover:bg-orange-600";
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-start space-y-2">
                <h3 className={`text-4xl sm:text-3xl md:text-5xl font-bold luckiest-guy-regular ${isDiet ? "text-lime-600" : "text-orange-500"}`}>
                  {cat.title}
                </h3>
              ...
              <div className="flex items-end justify-between mt-auto pt-4">
                <div className="flex flex-col items-start gap-2">
                  <span className={`text-[10px] sm:text-[11px] font-semibold rounded-full px-3 py-1 shadow-sm ${tagColor}`}>
                    {cat.tag}
                  </span>
                  <button className={`flex items-center gap-1 text-[11px] sm:text-[11px] font-medium text-white ${btnColor} px-3 py-1.5 rounded-full transition`}>
